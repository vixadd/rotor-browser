...
pref("xpinstall.signatures.required", false); #FIX ME
...
// Update service URL:
pref("app.update.url", "https://www.rotorbrowser.com/dist/rotorbrowser/update_2/%CHANNEL%/%BUILD_TARGET%/%VERSION%/%LOCALE%");
